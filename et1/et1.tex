...
\begin{flalign*}
S = \sum_{k=0}^{n-1} (\frac{1}{3})^{k} \cdot (k + 2)
\end{flalign*}
...
\end{flalign*}
\begin{flalign*}
S = \sum_{k=0}^{n-1} (\frac{1}{3})^{k} \cdot (k + 2) = -\frac{9}{2} \cdot \Bigl ( (\frac{1}{3})^{k+1} - 1 \Bigl ) (k+1) \Bigl |_{k=0}^{k=n} - \sum_{k=0}^{n-1} \Bigl ( -\frac{9}{2} \Bigl ( (\frac{1}{3})^{k+1} - 1 \Bigl ) \Bigl ) =
\end{flalign*}
\begin{flalign*}
